...
@click.command()
@click.option('--data-set', default='taxi_trip', help='Dataset To Ingest.Expected values: taxi_trip or taxi_zones')
...
@click.option('--target-table', default='green_taxi_data', help='Name of the target table in PostgreSQL.')
